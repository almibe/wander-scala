...
class ParserSuite extends FunSuite {
  ...
  //   val expected =
  //     Right(Seq(Term.Binding(TaggedField(UName("x"), Tag.Untagged), Term.IntegerLiteral(5))))
  //   assertEquals(result, expected)
  // }
  // test("parse Lambda") {
  ...
  //       Seq(
  //         Term.Binding(
  //           TaggedField(UName("id"), Tag.Untagged),
  //           Term.Lambda(UName("x"), Term.NameTerm(UName("x")))
  //         )
  //       )
  //     )
  ...
  //     Seq(
  //       Term.Binding(
  //         TaggedField(UName("zero"), Tag.Single(UName("Core.Int"))),
  ...
  //     Seq(
  //       Term.Binding(
  //         TaggedField(UName("x"), Tag.Function(Seq(UName("Core.Int"), UName("Core.Bool")))),
  ...
  //   val expected =
  //     Right(Seq(Term.Binding(TaggedField(UName("x"), Tag.Untagged), Term.IntegerLiteral(5), true)))
  //   assertEquals(result, expected)
  // }
}
